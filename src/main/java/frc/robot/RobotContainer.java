...
public class RobotContainer {
  ...
  private final Drivetrain mRobotDrive = new Drivetrain();

  private final XboxController navigator = new XboxController(ControllerConstants.kNavigatorPort);
  ...
  public RobotContainer() {
    ...
    .arcadeDrive(navigator.getY(GenericHID.Hand.kLeft), -navigator.getX(GenericHID.Hand.kRight)), mRobotDrive
    ));
